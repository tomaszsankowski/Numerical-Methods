...
F_coarse = sin(X_coarse*2*pi) + cos(2*Y_coarse*pi); % zadanie A: zmień definicję funkcji interpolowanej
...
title('Rzadsza siatka interpolacja')
xlabel('x')
ylabel('y')
zlabel('z')
...
title('Gesta siatka interpolacja)')
xlabel('x')
ylabel('y')
zlabel('z')
